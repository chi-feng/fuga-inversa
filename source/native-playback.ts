...
export function initializeNativePlayback({ audio, buttons, registration, status }: NativePlaybackOptions) {
  ...
  update();
  return {
    get instrument() { return selected.dataset.instrument as 'organ' | 'piano'; },
